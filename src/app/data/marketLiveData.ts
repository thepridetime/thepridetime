...
export const globalIndices: GlobalIndex[] = [
  { name: "TPT Global 500", country: "Global", value: 18432.56, change: 234.12, changePct: 1.29, flag: "🌐" },
...
export const industryIndices: IndustryIndex[] = [
  { name: "TPT Technology", symbol: "TPTTECH", value: 12847.23, change: 172.34, changePct: 1.36, ytd: 18.4, color: "#3b82f6" },
  { name: "TPT Finance", symbol: "TPTFIN", value: 8432.17, change: 45.22, changePct: 0.54, ytd: 11.2, color: "#10b981" },
  { name: "TPT Energy", symbol: "TPTENG", value: 6284.55, change: -32.18, changePct: -0.51, ytd: 7.8, color: "#f59e0b" },
  { name: "TPT Healthcare", symbol: "TPTHLT", value: 9102.67, change: 142.89, changePct: 1.59, ytd: 22.1, color: "#ef4444" },
  { name: "TPT Cyber", symbol: "TPTCYB", value: 5847.34, change: 234.56, changePct: 4.18, ytd: 31.7, color: "#8b5cf6" },
  { name: "TPT Manufacturing", symbol: "TPTMFG", value: 4523.89, change: -18.67, changePct: -0.41, ytd: 9.3, color: "#f97316" },
  { name: "TPT SmartCity", symbol: "TPTSC", value: 3284.12, change: 56.34, changePct: 1.74, ytd: 24.6, color: "#14b8a6" },
  { name: "TPT Supply Chain", symbol: "TPTSCP", value: 2947.66, change: 28.44, changePct: 0.97, ytd: 13.5, color: "#6366f1" },
  { name: "TPT AI Index", symbol: "TPTAI", value: 4521.80, change: 96.84, changePct: 2.19, ytd: 47.3, color: "#00d4ff" },
  { name: "TPT Sustainability", symbol: "TPTSUS", value: 3102.45, change: 41.22, changePct: 1.35, ytd: 19.8, color: "#84cc16" },
];
