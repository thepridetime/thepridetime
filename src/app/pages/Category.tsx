...
const categoryMeta: Record<string, {
  ...
  Markets: {
    description: "Comprehensive global markets intelligence covering equities, fixed income, commodities, forex, digital assets, and Alphaburg Report's proprietary industry indices.",
    color: "#00d4ff",
    stats: [
...
export function Category() {
  ...
  const meta = categoryMeta[categoryName] || {
    description: `Latest intelligence and analysis from Alphaburg Report on ${categoryName}.`,
    color: "#00d4ff",
    stats: [],
    subtopics: [],
  };
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="rounded-xl overflow-hidden" style={{ background: `linear-gradient(135deg, ${meta.color}22, #0d1f3c)` }}>
              <div className="border border-white/10 rounded-xl p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                  <div className="text-xs font-black uppercase tracking-widest mb-1" style={{ color: meta.color }}>Alphaburg Intelligence Report</div>
